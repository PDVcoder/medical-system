        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrescribedTreatmentDescription = table.Column<string>(type: "text", nullable: false),
                    ReqCreated = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ReqModified = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TakingSchedule = table.Column<string>(type: "text", nullable: false),
                    ReqCreated = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ReqModified = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrescribedTreatments_MedicalRecords_MedicalRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrescribedTreatments_MedicalRecordId",
